...
export const { HarnessVersion, LocalRunner, COMPONENT_KINDS, DETERMINISM_MODES } = mod;
export const { StaticUICapture, UiRepairFailureEvidence, REDACTION_STATES } = mod;
